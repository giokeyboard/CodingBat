...
namespace fizzBuzz
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             */
            Console.WriteLine($"[{String.Join(",", FizzBuzz(1, 6))}]");
            Console.WriteLine($"[{String.Join(",", FizzBuzz(1, 8))}]");
            Console.WriteLine($"[{String.Join(",", FizzBuzz(1, 11))}]");
        }
        ...
        private static string[] FizzBuzz(int start, int end)
        {
            ...
            {
                if (i % 3 == 0 && i % 5 == 0) output[i - start] = "FizzBuzz";
                else if (i % 3 == 0) output[i - start] = "Fizz";
                else if (i % 5 == 0) output[i - start] = "Buzz";
                else output[i - start] = Convert.ToString(i);
            }
