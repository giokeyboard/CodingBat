...
namespace sumHeights
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             * the start index and ending at the end index.
             ...
             */
            Console.WriteLine(SumHeights(new int[] { 5, 3, 6, 7, 2 }, 2, 4));
            Console.WriteLine(SumHeights(new int[] { 5, 3, 6, 7, 2 }, 0, 1));
            Console.WriteLine(SumHeights(new int[] { 5, 3, 6, 7, 2 }, 0, 4));
        }
