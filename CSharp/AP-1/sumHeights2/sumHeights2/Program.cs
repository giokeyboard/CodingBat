...
namespace sumHeights2
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             */
            Console.WriteLine(sumHeights2(new int[] { 5, 3, 6, 7, 2 }, 2, 4));
            Console.WriteLine(sumHeights2(new int[] { 5, 3, 6, 7, 2 }, 0, 1));
            Console.WriteLine(sumHeights2(new int[] { 5, 3, 6, 7, 2 }, 0, 4));
        }
        ...
        private static int sumHeights2(int[] heights, int start, int end)
        {
            ...
            {
                if (heights[i] < heights[i + 1]) change += 2 * (heights[i + 1] - heights[i]);
